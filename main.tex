...
\newcommand{\orcid}[1]{\href{https://orcid.org/#1}{\includegraphics[width=10pt]{ocrid.png}}}
...
% \title{DreamConnect: Connecting Dreams with Visual Brainstorming Instruction}
...
\author{
  ...
  % Ge-Peng Ji$^2$ \orcid{0000-0001-7092-2877} \and
  % Peng Xu$^3$ \orcid{0000-0002-6431-1110} \and \\
  % Ming-Ming Cheng$^4$ \orcid{0000-0001-5550-8758} \and
  % Christos Sakaridis$^1$ \orcid{0000-0003-1127-8887} \and
  % Luc Van Gool$^1$ \orcid{0000-0002-3445-5711}
}

\authorrunning{Sun~\etal} % if too long for running head
...
% \journalname{Visual Intelligence}
\journalname{}
...
% \vspace{-2em}  
  ...
  % \vspace{-5pt}
  % \caption{Given a sequence of brain signals and a corresponding instruction, \textbf{\model{}} precisely performs the desired operation on the visual content. For instance, if an individual envisions a lake view (as shown in the first row) and intends to transform it into a sunset scene (as indicated in the second row), our system accurately generates the desired sunset scene (displayed in the third row).}
